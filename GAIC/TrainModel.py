...
# parser.add_argument('--base_model', default='shufflenetv2', help='Pretrained base model')
# parser.add_argument('--base_model', default='vgg16', help='Pretrained base model')
# parser.add_argument('--base_model', default='resnet50', help='Pretrained base model')
...
# parser.add_argument('--net_path', default='weights/ablation/cropping/shufflenetv2/downsample4_multi_Aug1_Align9_Cdim8/79_0.000_0.000_0.000_0.000_0.005_0.005_0.003_0.003_0.005_0.005.pth',
...
data_loader_test = data.DataLoader(GAICD(image_size=args.image_size, dataset_dir=args.dataset_root, set='test1'),
...
def test():
    ...
    for k in range(4):
        acc4_5[k] = acc4_5[k]/200  #一共有200张测试图片
        acc4_10[k] = acc4_10[k]/200
        wacc4_5[k] = wacc4_5[k]/200
        wacc4_10[k] = wacc4_10[k]/200
...
def train():
    ...
    for epoch in range(epoch_num):
        ...
        for id, sample in enumerate(data_loader_train):
            ...
            out = net(image,roi)
# parser.add_argument('--base_model', default='vg
            ...
            sys.stdout.write('\r[Epoch %d/%d] [Batch %d/%d] [Train Loss: %.4f]' % (epoch+1, epoch_num, id+1, len(data_loader_train), avg_loss))
        ...
        torch.save(net.module.state_dict(), args.save_folder + '/' + repr(epoch+1) + '_%.3f_%.3f_%.3f_%.3f_%.3f_%.3f_%.3f_%.3f_%.3f_%.3f' % (acc4_5[0],acc4_5[1],acc4_5[2],acc4_5[3],acc4_10[0],acc4_10[1],acc4_10[2],acc4_10[3],avg_srcc,avg_pcc) + '.pth')

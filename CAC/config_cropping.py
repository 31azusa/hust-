...
class Config:
    ...
    predefined_pkl = os.path.join(data_root,
                                  'pdefined_anchors.pkl')  # download from https://github.com/luwr1022/listwise-view-ranking/blob/master/pdefined_anchors.pkl
